# Vendored from EEGPT (https://github.com/BINE022/EEGPT), file pretrain/modeling_pretraining.py.
# Original work (c) the EEGPT authors, licensed under the Apache License 2.0.
# Reference: Wang et al., "EEGPT: Pretrained Transformer for Universal and Reliable
# Representation of EEG Signals", NeurIPS 2024. See vendor/README.md for the full notice.
# Unmodified except for this header. Self-contained (torch only).
import math
import torch
